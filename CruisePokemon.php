...
class CruisePokemon extends Pokemon {
    ...
    public function calcular_Velocidad() {
        return (($this->peso / 25) * $this->numero_aletas) / 2;
    }

    public function __toString() {
        // Llamamos al método calcular_Velocidad()
        $velocidad = $this->calcular_Velocidad();
        return "Soy el CruisePokemon {$this->nombre}, mi peso es de {$this->peso} kg, mi velocidad es de {$velocidad} km/h, tengo {$this->numero_aletas} aletas.";
    }
}
?>
